...
## Стиль — тёмный гаражный

Зафиксирован в токенах `src/app/globals.css` (блок `.dark`) и в стори `Foundations/Основы`.
Графит вместо чёрного, янтарь как единственный акцент, моноширинный для цен, вылетов
и артикулов. Продукт всегда тёмный: это фирменный стиль, а не системная тема пользователя.
